...
class UserAdmin(admin.ModelAdmin):
    list_display = ('name', 'gender', 'occupation', 'email', 'message', 'pub_date', 'grade')
...
admin.site.site_header = "QuizMonkey Admin"
admin.site.index_title = "Welcome to QuizMonkey Administration Portal"